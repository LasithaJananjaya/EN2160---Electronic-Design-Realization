...
(library Library_1
	...
	(compDef "929850-01-03-RA" (originalName "929850-01-03-RA") (compHeader (numPins 3) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://multimedia.3m.com/mws/media/22500O/3mtm-boardmount-skt-100-100x-100strt-sldr-tails-ts0815.pdf")
		(attr "<Component Height>" "8.26")
		(attr "<STEP Filename>" "929850-01-03-RA.stp")
