...
(library Library_1
	...
	(patternDef "617291011BLF" (originalName "617291011BLF")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -1.250, -6.990) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -7.35 1.01) (pt 4.85 1.01) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.85 1.01) (pt 4.85 -14.99) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.85 -14.99) (pt -7.35 -14.99) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -7.35 -14.99) (pt -7.35 1.01) (width 0.025))
		)
	...
	(compDef "61729-1011BLF" (originalName "61729-1011BLF") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.amphenol-cs.com/media/wysiwyg/files/drawing/61729.pdf")
		(attr "<Component Height>" "11.5")
		(attr "<STEP Filename>" "61729-1011BLF.stp")
		(attr "<STEP Offsets>" "X=-1.25;Y=-15;Z=5.96")
